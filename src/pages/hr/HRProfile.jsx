...
export default function HRProfile() {
  ...
  const [role] = useState(storedUser.role || "HR");
  
  // New Employee Details
  const [designation, setDesignation] = useState(storedUser.designation || "HR");
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-500">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-3xl font-black tracking-tight text-white">HR Profile</h2>
